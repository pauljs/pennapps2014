...
public class RequestMultiple {
	...
	public void makeRequest() throws Exception{
		...
		request.getElement("fields").appendValue("PREVIOUS_CLOSE");
...
//				 System.exit(1);
			 ...
			 for (int i = 0; i < numItems; ++i) {
				 ...
				 if (securityData.hasElement("securityError")) {
				 	...
				 	Security tempSec = new Security(fieldData.getElementAsString("DS002"), security, fieldData.getElementAsFloat64("PX_LAST"), 
				 									fieldData.getElementAsFloat64("HIGH"), fieldData.getElementAsFloat64("LOW"), 
				 									fieldData.getElementAsFloat64("OPEN"), 0, 0, 0, 0);
