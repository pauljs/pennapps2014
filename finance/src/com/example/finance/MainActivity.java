...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public AppSectionsPagerAdapter(FragmentManager fm) {
            ...
            fragmentList.add(floorAlertFragment);
            
            //Current Stocks adding
        	Fragment fragment = new CurrentStocksFragment();
          ...
          //Current Stocks adding
        	Fragment highPriorityAlertsFragment = new HighPriorityAlertsFragment();
            Bundle argsHPA = new Bundle();
...
//                    });
    ...
    public void addStockBtnClicked(View v) {
		((CurrentStocksFragment) mAppSectionsPagerAdapter.getItem(1)).addStockBtnClicked(v);
    }
//    public void addStockBtnClicked(View v) {
//		EditText stockEditText = (EditText) findViewById(R.id.stockEditText);
//		Toast.makeText(this, stockEditText.getText().toString(), Toast.LENGTH_LONG).show();
//    }
